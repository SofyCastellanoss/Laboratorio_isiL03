// SistemaBancarioLegacy.cpp - Codigo a auditar
#include <iostream>
#include <fstream>
#include <string>
#include <cstring>
...
int main() {
    CuentaLegacy* miCuenta = crearCuenta("Juan Perez", 1000.0, 1);
    procesarRetiro(miCuenta, 200.0);
